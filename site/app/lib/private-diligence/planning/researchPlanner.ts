...
export function buildPrivateDiligenceProviderPlan(
  ...
  return [
    ...
    { providerId: "stateRegistry", providerName: "State business registry", sourceTier: 1, providerCategory: "officialRegistration", selected: Boolean(input.state), reason: "Legal formation and status verification with manual fallback" },
