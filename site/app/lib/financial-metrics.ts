...
export const FINANCIAL_METRICS_V1: MetricConfig[] = [
  ...
  {
    metricId: "diluted-eps",
    definitionId: "reported-diluted-earnings-per-share",
    duration: true,
    concepts: [
  ...
  {
    metricId: "shares-outstanding",
    definitionId: "reported-common-shares-outstanding",
    duration: false,
    concepts: [
...
export const FINANCIAL_DEFINITION_IDS = {
  ...
  dilutedEps: "reported-diluted-earnings-per-share",
  sharesOutstanding: "reported-common-shares-outstanding",
...
export function financialPeriodsFromRegistry(
  ...
  const periods: FinancialPeriod[] = anchorDates.map((periodEnd) => {
    const selections = {
      ...
      dilutedEps: selectedMetric(registry, companyId, "diluted-eps", periodEnd, [FINANCIAL_DEFINITION_IDS.dilutedEps]),
      sharesOutstanding: selectedMetric(registry, companyId, "shares-outstanding", periodEnd, [FINANCIAL_DEFINITION_IDS.sharesOutstanding]),
    ...
    return {
      ...
      dilutedEps: value(selections.dilutedEps),
      sharesOutstanding: value(selections.sharesOutstanding),
